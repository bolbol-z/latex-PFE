...
\chapteropening{03}{Réalisation du\\système}{Réalisation du système}{chap:realisation-systeme}
...
Ce volet présente l’environnement matériel et logiciel utilisé pour le développement de la plateforme, ainsi que les outils nécessaires à sa mise en œuvre. 
...
\vspace{\fill}\includegraphics[height=2.5cm,keepaspectratio]{figures/Gigabyte_Aorus.png}\vspace{\fill} &
...
\vspace{\fill}\includegraphics[height=2.5cm,keepaspectratio]{figures/macbook_air.png}\vspace{\fill} &
MacBook Air M2 &
Processor : Apple M2
...
\vspace{\fill}\includegraphics[height=2.5cm,keepaspectratio]{figures/Lenovo _Loq .png}\vspace{\fill} &
Lenovo Loq 15irx9 &
...
\subsubsection{Environnement de développement utilisé}
  L’environnement de développement utilisé est un ensemble d’outils permettant l’écriture, la gestion et le débogage du code source de la plateforme.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.90\textwidth]{figures/Interface_d’authentification.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figures/Interface_de_vérification_d’identité.png}
...
\noindent La figure~\ref{fig:authentification-societe} ci-dessous illustre l’interface d’authentification, dans laquelle la société doit simplement saisir son adresse e-mail et son mot de passe pour se connecter.
...
Cette section présente les différentes interfaces dédiées à l’étudiant.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_profil_etudiant.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_de_generation_du_CV_ATS.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_de_validation_du_CV_ATS.png}
\caption{Interface de validation du CV ATS}
\label{fig:validation-cv-ats}
\end{figure}

\noindent La figure \ref{fig:cv-ats-genere} illustre le CV généré. Depuis cet espace, l'étudiant a la possibilité de modifier ses informations, de télécharger son CV au format PDF et de cliquer sur le bouton "Évaluer votre CV" afin de stocker le CV, lancer le calcul de ses scores ATS et d'employabilité.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_CV_ATS_genere.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_tableau_de_bord_de_laetudiant.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_de_prediction_du_score_daemployabilite.png}
...
\noindent Les figures~\ref{fig:tableau-bord-admin}~et~\ref{fig:tableau-bord-admin-2} ci-dessous présentent le tableau de bord de l'administrateur, un espace de pilotage centralisant les indicateurs clés ainsi que des graphiques d'analyse. Elles permettent de visualiser la répartition des étudiants par filière, d’observer la distribution des scores ATS et des scores d’employabilité, ainsi que de consulter la liste des cinq étudiants les mieux classés selon leur score d’employabilité.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_tableau_de_bord_de_laadministrateur.png}
\captionsetup{skip=0.75cm}
\caption{Partie supérieure de l’interface du tableau de bord de l'administrateur}
\label{fig:tableau-bord-admin}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_tableau_de_bord_de_laadministrateur_2.png}
\captionsetup{skip=0.75cm}
\caption{Partie inférieure de l’interface du tableau de bord de l'administrateur}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_score_daemployabilite.png}
\caption{Partie supérieure de l’interface du score d'employabilité}
\label{fig:score-employabilite}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_score_daemployabilite_2.png}
\caption{Partie inférieure de l’interface du score d'employabilité}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_daadequation_Formation-Emploi.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_du_referentiel_des_competences.png}
\caption{Interface du référentiel des compétences}
\label{fig:referentiel-competences}
\end{figure}

\noindent La figure~\ref{fig:suivi-etudiants-filiere} ci-dessous présente l'interface Suivi des étudiants par filière, ainsi que leur score CV ATS et leur score d'employabilité.

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_de_suivi_des_etudiants_par_filiere.png}
\caption{Interface de suivi des étudiants}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{figures/Interface_de_consultation_des_candidatures.png}
