...
\newcommand{\chapteropening}[4]{%
  ...
  % ── 3. CHAPITRE — stretched to number width + letter-spacing ──────────────
  \noindent\resizebox{\chapteropeningnumwidth}{!}{%
    {\fontsize{11}{11}\selectfont\bfseries\rmfamily\textls[200]{CHAPITRE}}%
  }\par%

  % ── 4. Measure height of CHAPITRE label for rule start ────────────────────
  \settototalheight{\chapiterheight}{%
    {\fontsize{11}{11}\selectfont\bfseries\rmfamily CHAPITRE}}%
