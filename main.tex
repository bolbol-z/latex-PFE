...
% ─────────────────────────────────────────────────────────────────────────────
% PAGE DE FIN DU RAPPORT
% ─────────────────────────────────────────────────────────────────────────────
\newpage
\thispagestyle{empty}
\vspace*{\fill}
\begin{center}
  {\AlexBrush\Huge\color{MidnightBlue!90}Fin du rapport}
...
\begin{center}
  \vspace{1cm}
  {\footnotesize
    %\href{https://ar.wikipedia.org/wiki/%D8%B9%D9%88%D8%AF_%D8%A3%D8%A8%D8%AF%D9%8A}
    {The Cycle Ends Here}

    \vspace{0.3cm}

    \copyright{} 2026 LogiLink. Tous droits réservés.
  }
\end{center}
