...
\begin{center}
  \begin{minipage}{0.85\textwidth}
    ...
    Source de tendresse, de patience et d'amour inconditionnel. Tes prières quotidiennes, tes encouragements et ta confiance en moi ont été mon plus grand moteur tout au long de ce parcours. Ce travail est le fruit de ton dévouement.\\
     ...
     \textbf{À ma précieuse grand-mère Nafissa},\\

  Pour ton amour inconditionnel, ta tendresse et tes prières qui m’ont toujours accompagné. Merci pour ton soutien, ta bienveillance et les valeurs que tu m’as transmises. Que ce travail soit le témoignage de ma profonde gratitude et de toute l’affection que je te porte.\\
    ...
    \textbf{À mes chers binômes Nour et Bilel},\\

  En souvenir de notre excellente collaboration, de notre esprit d'équipe et des défis que nous avons relevés ensemble pour mener ce projet à bien. Ce fut une fierté de partager cette aventure technique et humaine à vos côtés.\\
...
\begin{center}
  \begin{minipage}{0.85\textwidth}
    ...
    À celle qui a parcouru ce chemin à mes côtés avec patience, dévouement et un amour sans limite. Ton soutien tout au long de ces années a eu un impact que les mots peinent à décrire. Je te dédie ce travail en témoignage de ma profonde reconnaissance pour tout ce que tu m’as apporté.\\
     ...
     \textbf{À ma chère grand-mère Zahra},\\

  Je tiens à te dédier ce modeste travail avec toute ma gratitude pour l’amour, l’attention et le soutien que tu m’as apportés depuis mon enfance. Tu as toujours été présente à mes côtés, m’accompagnant par tes encouragements et ta bienveillance.\\
